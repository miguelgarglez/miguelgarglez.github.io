// NOTE: Keep this file identical to chat-worker/src/agent/upstream.ts.
// Everything below the UpstreamApi type export must match the Worker copy
// byte-for-byte (enforced by chat-worker/test/upstream-copy.test.ts).
